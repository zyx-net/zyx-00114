...
const DEFAULT_DB = {
  ...
  vaultImportPackages: [],
  sensitiveDeskGrants: [],
  sensitiveDeskSessions: [],
  sensitiveDeskConfig: { maxDurationMinutes: 120, defaultDurationMinutes: 30 },
  sensitiveDeskAccessLogs: [],
  sensitiveDeskImportPackages: []
};
...
function read() {
  ...
  try {
    ...
    return {
      ...
      sensitiveDeskGrants: data.sensitiveDeskGrants || [],
      sensitiveDeskSessions: data.sensitiveDeskSessions || [],
      sensitiveDeskConfig: data.sensitiveDeskConfig || { maxDurationMinutes: 120, defaultDurationMinutes: 30 },
      sensitiveDeskAccessLogs: data.sensitiveDeskAccessLogs || [],
      sensitiveDeskImportPackages: data.sensitiveDeskImportPackages || []
    };
  } catch (e) {
    return JSON.parse(JSON.stringify(DEFAULT_DB));
  }
